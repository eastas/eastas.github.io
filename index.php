...
if (!wp_is_mobile() || get_option('eaplayer_options')['mobile']) {
    ...
    {
        wp_enqueue_style('player', 'https://cdn.jsdelivr.net/npm/aplayer/dist/APlayer.min.css', array(), PLAYER_VERSION, 'all');
        wp_enqueue_script('player-js', 'https://cdn.jsdelivr.net/npm/aplayer/dist/APlayer.min.js', array(), PLAYER_VERSION, true);
        wp_enqueue_script('meting-js', 'https://cdn.jsdelivr.net/npm/meting@2/dist/Meting.min.js', array(), PLAYER_VERSION, true);
    }
